# docker run --ipc=host --ulimit memlock=-1 --ulimit stack=67108864 --rm --gpus all --mount type=bind,source="$(pwd)",destination="$(pwd)" -w /home/yongjer/程式/python/food_classification ak:latest 
